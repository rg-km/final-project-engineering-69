      ...
      <div class="container mt-lg-5">
        <div class="row align-items-start">
          <div class="col text-white my-5">
            ...
            <a href="https://www.instagram.com/" className="medsos">
              <img src={Instagram} alt="logo" />
            </a>
            <a href="https://www.facebook.com/" className="medsos">
              <img src={Facebook} alt="logo" />
            </a>
            <a href="https://www.youtube.com/" className="medsos">
              <img src={YouTube} alt="logo" />
            </a>
            <a href="https://www.linkedIn.com/" className="medsos">
              <img src={Linkedin} alt="logo" />
            </a>
            <h5 class="mt-4">Hubungi kami</h5>
            <a href="https://www.whatsapp.com/" className="medsos">
              <img src={Whatsapp} alt="logo" />
            </a>
            <a href="#" className="medsos">
