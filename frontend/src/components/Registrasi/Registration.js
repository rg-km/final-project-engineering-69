        ...
        <form className="form">
          <div className="form-group">
            ...
            <div className="form-inputs">
              ...
              <input type="text" name="username" className="form-input form-control form-control-sm" />
            </div>
            <div className="form-inputs">
            ...
            <div className="form-inputs">
              ...
              <input type="password" name="password" className="form-input form-control form-control-sm" />
            </div>
